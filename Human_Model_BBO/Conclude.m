...
% 
% File description: Output final results of evolutionary optimization algorithm
...
% save resulting solution, identifying it by the date and time stamp and
% the selected weights for the muscles
save([datestr(now,'mm-dd-yyyy_HH-MM') '_MuscWeights' num2str(OPTIONS.weights)])
return