...
% 
% File description: Compute the minimum cost, the average cost, the minimum
% number of constraint violations, and the average number of constraint 
% violations in the population
