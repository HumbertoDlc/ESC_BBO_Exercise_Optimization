...
% 
% File description: Biogeography-based optimization (BBO) software for 
% minimizing a continuous function.

function [Population] = BBO(ProblemFunction, DisplayFlag, LinearFlag, Blending, ConstrMethod, RandSeed, popsize, Maxgen)
...
for GenIndex = 1 : OPTIONS.Maxgen
    ...
    % Calculate cost
    [Population,OPTIONS] = OPTIONS.CostFunction(Population, OPTIONS);
    % Replace the worst with the previous generation's elites
    Population = PopSort([Population, ElitePop], OPTIONS.ConstrMethod, GenIndex, OPTIONS);
