...
% 
% File description: Sort the population members from best to worst, epsilon-
% level comparison method was used


function [Population] = PopSort(Population, ConstrMethod, GenIndex,OPTIONS)
persistent epsilon0
    ...
    elseif ConstrMethod == 9
        ...
        while true
            ...
            for i = 1 : PopSize-1
                ...
                Swap2 = (Population(i).cost > Population(i+1).cost) && (Population(i).G == Population(i+1).G);
                Swap3 = (Population(i).G > Population(i+1).G) && (Population(i).G > epsilon);
                if Swap1 || Swap2 || Swap3
                    temp = Population(i);
                    Population(i) = Population(i+1);
                    Population(i+1) = temp;
